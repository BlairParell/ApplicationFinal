...
class Message extends React.Component{
  ...
  onReplyPress = () => { // Logic for replying to msgs
    ...
    this.props.navigation.navigate('SendMessageModal', {selectedString: this.props.item.title.slice(6,this.props.item.title.length), selectedContacts: this.props.item.sender_id}); // For Replying to msg 
  }
  onForwardPress = () => { // Logic for forwarding the msgs
    this.setState({ isModalVisible: !this.state.isModalVisible }); // For showing the menu
    this.props.navigation.navigate('SendMessageModal', {selectedMsg: this.props.item.text}); // For forwarding the msgs
